...
export const TestimonialsSection = component$(() => {
  ...
  return (
    <section class="container mx-auto flex  flex-col gap-8 px-4 text-black md:px-0">
      ...
      <button class="mt-12 md:w-[340px] w-full max-w-full gap-2.5 self-center rounded bg-[#F02480] px-4 py-3 text-white shadow-sm max-md:mt-10 font-semibold text-base">
